...
interface AdManagerInterface extends ethers.utils.Interface {
  ...
  events: {
    ...
    "ClientAllowed(uint256,address)": EventFragment;
    "ClientDenied(uint256,address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "ClientAllowed"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "ClientDenied"): EventFragment;
...
export class AdManager extends BaseContract {
  ...
  filters: {
    ...
    ClientAllowed(
      ...
      [BigNumber, string],
      { adId: BigNumber; clientAddress: string }
    >;
